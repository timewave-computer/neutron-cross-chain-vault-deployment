...
pub const MARS_LEND_LABEL: &str = "mars_lend";
pub const SUPERVAULT_LP_LABEL: &str = "supervault_lp";
pub const MARS_WITHDRAW_LABEL: &str = "mars_withdraw";
pub const SUPERVAULT_WITHDRAW_LABEL: &str = "supervault_withdraw";
pub const SETTLE_OBLIGATION_LABEL: &str = "settle_obligation";
pub const PHASE_CHANGE_LABEL: &str = "phase_change";
